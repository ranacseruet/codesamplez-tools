...
describe('root document generation', () => {
  it('renders the generated landing page with structured data and grouped tool cards', () => {
    ...
    expect(html).toContain('<link rel="canonical" href="https://tools.codesamplez.com/">');
    ...
    expect(html).toContain('"url":"https://tools.codesamplez.com/json-formatter/"');
    expect(html).toContain('"url":"https://tools.codesamplez.com/text-analyzer/"');
