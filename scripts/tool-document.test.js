...
describe('tool document generation', () => {
    it('joins urls without dropping nested paths', () => {
        expect(joinUrl('https://codesamplez.com', '/json-formatter-tool/'))
            .toBe('https://codesamplez.com/json-formatter-tool/');
        expect(joinUrl('https://codesamplez.com/', 'text-analyzer-tool/images/featured.png'))
            .toBe('https://codesamplez.com/text-analyzer-tool/images/featured.png');
    });
    ...
    it('renders a module tool document with metadata and shell placeholders', () => {
        ...
        expect(html).toContain('<link rel="canonical" href="https://codesamplez.com/diff-checker-tool/">');
        expect(html).toContain('<meta property="og:image" content="https://codesamplez.com/diff-checker-tool/images/featured.png">');
    ...
    it('renders prerendered markup for a representative module tool', () => {
        ...
        expect(html).toContain('https://codesamplez.com/base64-converter-tool/images/featured.png');
    });
});
