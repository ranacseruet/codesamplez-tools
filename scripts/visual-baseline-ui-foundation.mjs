...
export async function runVisualBaselineCapture() {
  const requestedRouteIds = splitCommaList(process.env.QA_VISUAL_ROUTE_IDS);
  const { config, configPath } = await loadVisualRegressionConfig();
